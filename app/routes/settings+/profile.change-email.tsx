...
export async function handleVerification({
	...
	void sendEmail({
		...
		subject: 'devChallenges Chat App email changed',
...
export async function action({ request }: ActionFunctionArgs) {
	...
	const response = await sendEmail({
		...
		subject: `devChallenges Chat App Email Change Verification`,
...
export function EmailChangeEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>devChallenges Chat App Email Change</E.Text>
				</h1>
				<p>
					<E.Text>
...
export function EmailChangeNoticeEmail({ userId }: { userId: string }) {
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Your devChallenges Chat App email has been changed</E.Text>
				</h1>
				<p>
					<E.Text>
						We're writing to let you know that your devChallenges Chat App email has been
						changed.
					</E.Text>
				</p>
				<p>
